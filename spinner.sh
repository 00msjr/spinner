...
usage() {
  echo -e "${BOLD}Usage:${RESET} spinner [options]"
  echo
  echo -e "${BOLD}Example usage:${RESET} spinner -s dots5 -c green -m 'Loading files...'"
  echo
  ...
  echo
  echo -e "${BOLD}Usage with pipe:${RESET} myscript.py | spinner --spinner dots5 -m 'Processing...'"
  exit 0
}
